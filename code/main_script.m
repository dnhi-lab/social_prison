...
% Create variables 
V.DGself = data.allP(:,18);
V.UGself = data.allP(:,19);
...
[DG.PCLR_rho, DG.PCLR_pval] = corr(V.DGself, data.allP(:,PCLRcolumn), 'Type', 'Spearman');
[UG.PCLR_rho, UG.PCLR_pval] = corr(V.UGself, data.allP(:,PCLRcolumn), 'Type', 'Spearman');
[DG_UG.PCLR_rho, DG_UG.PCLR_pval] = corr(V.DGself - V.UGself, data.allP(:,PCLRcolumn), 'Type', 'Spearman');

% Calculate correlations but for the 2 factors
[DG.PCLRf1_rho, DG.PCLRf1_pval] = corr(V.DGself, data.allP(:,70), 'Type', 'Spearman');
[DG.PCLRf2_rho, DG.PCLRf2_pval] = corr(V.DGself, data.allP(:,71), 'Type', 'Spearman');
[UG.PCLRf1_rho, UG.PCLRf1_pval] = corr(V.UGself, data.allP(:,70), 'Type', 'Spearman');
[UG.PCLRf2_rho, UG.PCLRf2_pval] = corr(V.UGself, data.allP(:,71), 'Type', 'Spearman');
[DG_UG.PCLRf1_rho, DG_UG.PCLRf1_pval] = corr(V.DGself - V.UGself, data.allP(:,70), 'Type', 'Spearman');
[DG_UG.PCLRf2_rho, DG_UG.PCLRf2_pval] = corr(V.DGself - V.UGself, data.allP(:,71), 'Type', 'Spearman');
